...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-sky-950 to-sky-900 px-4 text-center">
      ...
      <h1 className="mt-4 font-display text-2xl font-bold text-white">Página no encontrada</h1>
      <p className="mt-2 max-w-sm text-sky-400">
        La página que buscas no existe o ha sido movida. ¿Volvemos a planificar aventuras?
      </p>
      <Link
        to="/"
