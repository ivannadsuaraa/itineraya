        ...
        <PageTransition personality="scale">
          ...
          <section className="relative overflow-hidden bg-gradient-to-b from-sky-950 to-sky-900 px-4 py-12 sm:py-16">
            ...
            <div className="relative mx-auto max-w-3xl text-center">
              ...
              <p className="mt-3 text-base text-sky-200 sm:text-lg">{t("explore.subtitle")}</p>
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex h-11 flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-sky-900 to-[#1E6B9A] px-4 text-xs font-bold text-white shadow-sm transition hover:shadow-md active:scale-95"
            >
